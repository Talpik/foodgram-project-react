    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True, verbose_name='created')),
                ('sorting', models.PositiveIntegerField(default=0, verbose_name='sorting')),
                ('name', models.CharField(choices=[(0, 'Завтрак'), (1, 'Обед'), (2, 'Ужин')], max_length=20, verbose_name='meal time')),
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='recipes.productcategory'),
        ),
    ]
